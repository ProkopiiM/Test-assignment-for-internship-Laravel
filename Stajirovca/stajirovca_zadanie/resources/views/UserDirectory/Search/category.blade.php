...
<div
    style="display: flex">
    <div>
        <form id="categoryForm" method="GET" action="{{ route('category.index') }}">
            <div style="display: block; flex-direction: row">
                <div class="category-block">
                    <div>
                        Поиск по категории:
                    </div>
                    <input style="max-width: 150px" onchange="submitForm()" type="text" name="search" class="search-input" placeholder="Поиск" value="{{ request('search') }}">
                </div>
                <div class="category-block">
                    <div>
                        Сортировка:
                    </div>
                    <select style="border: 1px solid gray; border-radius: 5px" name="sort" onchange="submitForm()">
                ...
                <div class="category-block">
                    ...
                    <select style="width: 50%; border: 1px solid gray; border-radius: 5px" name="paginate" onchange="submitForm()">
                ...
                <div class="category-block">
                    ...
                    <select style="width: 50%; border: 1px solid gray; border-radius: 5px" name="category_id" onchange="submitForm()">
                    @foreach($categories as $category_button)
                            <option value="{{ $category_button->id }}" {{ request('category_id') == $category_button->id ? 'selected' : '' }}>{{ $category_button->name }}</option>
                    @endforeach
                    </select>
                </div>
                <div class="category-block">
