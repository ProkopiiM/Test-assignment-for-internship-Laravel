...
{
    /*поиск, сортировка и фильтрация по категории товара*/
    public function index(Request $request)
    {
        ...
        return view('UserDirectory.Search.category', ['manufacturers'=>Manufacture::all(),'categories'=>Category::all(),'category' => $category, 'products' => $products]);
    }
}
